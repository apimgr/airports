...
func (s *Server) handleServerHelpAPI(w http.ResponseWriter, r *http.Request) {
	s.respondItem(w, http.StatusOK, map[string]interface{}{
		...
		"endpoints": []map[string]string{
			...
			{"method": "GET", "path": "/api/v1/airports/search?q=", "description": "Full-text search"},
			{"method": "GET", "path": "/api/v1/airports/nearby?lat=&lon=&radius=", "description": "Airports within radius"},
			{"method": "GET", "path": "/api/v1/airports/within?lat_min=&lat_max=&lon_min=&lon_max=", "description": "Airports within bounding box"},
			{"method": "GET", "path": "/api/v1/airports/autocomplete?q=", "description": "Airport code/name autocomplete"},
			...
			{"method": "GET", "path": "/api/autodiscover", "description": "Server settings and CLI discovery (unversioned)"},
		},
